...
export default function PharmacyStore({ merchant, products }: PharmacyStoreProps) {
    ...
    return (
        <div className="min-h-screen font-sans selection:bg-black selection:text-white relative bg-black">
            ...
            {/* 1. HEADER & ORIGIN - BLUE SECTION (#4A90E2) */}
            <section className="relative bg-[#4A90E2] text-white pt-6 pb-24 px-6 lg:px-12 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-20 mb-8">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        <div>
                            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#D4AF37] block mb-4">The Apothecary</span>
                            <h1 className="text-5xl md:text-8xl font-heading font-light tracking-tighter text-white leading-[0.85]">
                                {merchant?.businessName || 'PHARMACY'}<span className="text-[#D4AF37]">.</span>
                            </h1>
                            <div className="flex items-center gap-6 mt-10 text-[11px] font-black uppercase tracking-widest text-white/40">
                                <div className="flex items-center gap-2 uppercase">
                                    <Heart size={12} className="text-[#D4AF37]" /> Trusted Care
                                </div>
                                <div className="flex items-center gap-2 uppercase">
                                    <Clock size={12} className="text-[#D4AF37]" /> 24/7 Availability
                                </div>
                                <div className="flex items-center gap-2 uppercase">
                                    <CreditCard size={12} className="text-[#D4AF37]" /> Card Accepted
                                </div>
                            </div>
                        </div>
                        <p className="text-white/30 text-xs md:text-sm max-w-sm font-medium leading-relaxed opacity-80">
                            Expertly curated health and wellness essentials. From life-saving medicines to premium personal care, delivered with speed and discretion.
                        </p>
                    </div>
                </div>
            ...
            {/* 2. GOLD SECTION - THE CLEAN REBUILD (#D4AF37) */}
                                ...
                                {categories.filter(c => c !== 'Featured items').map(cat => {
                                    ...
                                    return (
                                        <motion.div key={cat} id={`section-${cat}`} variants={staggerItem} className="scroll-mt-24 pt-2">
                                            <div className="lg:sticky lg:top-0 mb-8 lg:border-b border-black/5 pb-6 bg-[#D4AF37]/90 lg:backdrop-blur-md -mx-4 px-4 z-10">
                                                            ...
                                                            <div className="relative shrink-0 w-28 md:w-36 h-full">
                                                                ...
                                                                <div className="absolute bottom-2 right-2 z-20">
                                                                    {cartItem ? (
                                                                        ...
                                                                        <button
                                                                            onClick={() => addItem(product)}
                                                                            className="w-10 h-10 bg-white text-black rounded-full flex items-center justify-center shadow-lg border border-black/[0.03] hover:bg-black hover:text-white transition-all transform hover:scale-110 active:scale-95"
                                                                        >
                                                                            <Plus size={18} />
                                                                        </button>
                                                                    )}
